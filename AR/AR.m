...
xlabel('\it{}r_p')
ylabel('\it{}\eta_{sp}')
errorbar(rp,eta,se_eta/2,'-.o','MarkerSize',10,'MarkerEdgeColor',color{1},'Linewidth',2.5,'color',color{1});

subplot(2,1,2)
hold on;
xlabel('\it{}r_p')
ylabel('\it{}N_1 / E_Y')
plot(rp,N1/EY,'-.o','MarkerSize',10,'MarkerEdgeColor',color{1},'Linewidth',2.5,'color',color{1});
...
xlabel('\it{}r_p')
ylabel('\it{}\eta_{sp}')
errorbar(rp,eta,se_eta/2,'-.o','MarkerSize',10,'MarkerEdgeColor',color{2},'Linewidth',2.5,'color',color{2});

subplot(2,1,2)
hold on;
xlabel('\it{}r_p')
ylabel('\it{}N_1 / E_Y')
plot(rp,N1/EY,'-.o','MarkerSize',10,'MarkerEdgeColor',color{2},'Linewidth',2.5,'color',color{2});

%% figure formatting
tickx = 2;
name = {'\it{}rp_s \rm{}= 20.0','\it{}rp_s \rm{}= 10.0'};
for i=1:2 
