...
for i=1:nMu
    for k=1:nAtt
        ...
        [r, etaDataB(i,k)] = process_stress_lbox_eta_basis(filePrefix, basisStrain, 2, sidex, nfib, nseg, rps, kb, a, EY, Imom, eta0);
        % number of contacts
...
for i=1:nMu
    for k=1:nAtt
        for j=1:nA
            ...
            % viscosity
            [r, etaData(i,k,j)] = process_stress_lbox_eta(filePrefix, 5, sidex, nfib, nseg, rps, kb, a, EY, Imom, eta0);
            % number of contacts
